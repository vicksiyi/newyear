...
CREATE TABLE `companys`  (
  ...
  `symbol` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '快递公司符号',
...
CREATE TABLE `express`  (
  ...
  `status` int(0) NULL DEFAULT 0 COMMENT '当前状态 0=>未发货 1=>已发货 2=>已收到',
  PRIMARY KEY (`uuid`) USING BTREE,
...
CREATE TABLE `invites`  (
  ...
  `status` int(0) NULL DEFAULT 0 COMMENT '状态 0=>未取 1=>已取',
  `update` timestamp(0) NULL DEFAULT NULL COMMENT '更新时间/取货时间',
...
CREATE TABLE `notices`  (
  ...
  `status` int(0) NULL DEFAULT 1 COMMENT '状态 0=>已删除 1=>发布',
  `time` timestamp(0) NOT NULL COMMENT '通知建立时间',
  `update` timestamp(0) NULL DEFAULT NULL COMMENT '通知更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `orders`  (
  `uuid` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'uuid',
  `msg` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '订单备注',
  `status` int(0) NULL DEFAULT 0 COMMENT '订单状态 0=>已付款未发货/正在处理中 1=>已发货/已准备好',
